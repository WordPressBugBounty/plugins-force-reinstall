...
if (\PHP_VERSION_ID < 80400) {
     ...
     */
    final class ForceReinstall_ReflectionConstant
    {
        /**
         * @var string
         *
        ...
        {
            throw new Exception("Serialization of 'ForceReinstall_ReflectionConstant' is not allowed");
        }

        public function __wakeup(): void
        {
            throw new Exception("Unserialization of 'ForceReinstall_ReflectionConstant' is not allowed");
        }
    }
}
