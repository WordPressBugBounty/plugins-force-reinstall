...
use RichardMuvirimi\ForceReinstall\Vendor\GuzzleHttp\Cookie\CookieJarInterface;
        ...
        return static function (callable $handler): callable {
            return static function ($request, array $options) use ($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('cookies must be an instance of RichardMuvirimi\ForceReinstall\Vendor\GuzzleHttp\Cookie\CookieJarInterface');
                }
